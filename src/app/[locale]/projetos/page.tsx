...
const projectKeys = ["madlab", "suite", "farmfresh", "instagram"] as const;
        ...
        <div className="pt-32 container mx-auto px-4 max-w-6xl relative z-10">
          ...
          >
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight text-glow mb-4">
              {t("titulo")} <span className="text-[var(--color-primary)]">{t("titulo_destaque")}</span>
            </h1>
          ...
          <div className="flex flex-col gap-10">
            {projectsData.map((project, index) => {
              ...
              const features = [
                t(`projects.${key}.features.f1`),
                t(`projects.${key}.features.f2`),
                t(`projects.${key}.features.f3`),
                t(`projects.${key}.features.f4`),
              ];
                ...
                >
                  ...
                  <div className="w-full lg:w-3/5 p-6 sm:p-10 flex flex-col justify-between">
                    <div>
                      ...
                      <h3 className="text-[var(--color-primary)] font-medium text-lg mb-4">{t(`projects.${key}.pitch`)}</h3>
